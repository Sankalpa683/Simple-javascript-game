    ...
    $(document).ready(function () {
      document.onkeydown = function (e) {
        ...
        if (e.keyCode == 39) {
          ...
          var mandel_top = parseInt(
            window.getComputedStyle(mandel).getPropertyValue("left")
          );
      ...
      setInterval(function () {
        ...
        var gunda_left = parseInt(
          window.getComputedStyle(gunda).getPropertyValue("left")
        );
        // finding the top position of id gunda
        var gunda_top = parseInt(
          window.getComputedStyle(gunda).getPropertyValue("top")
        );

        // finding the left position of id player
        var mandel_left = parseInt(
          window.getComputedStyle(mandel).getPropertyValue("left")
        );
        // finding the top position of id player
        var mandel_top = parseInt(
          window.getComputedStyle(mandel).getPropertyValue("top")
        );
